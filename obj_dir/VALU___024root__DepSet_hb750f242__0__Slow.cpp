...
VL_ATTR_COLD void VALU___024root___dump_triggers__act(VALU___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge tb.clk or posedge tb.rst)\n");
    }
...
VL_ATTR_COLD void VALU___024root___dump_triggers__nba(VALU___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge tb.clk or posedge tb.rst)\n");
    }
...
VL_ATTR_COLD void VALU___024root___ctor_var_reset(VALU___024root* vlSelf) {
    ...
    // Body
    vlSelf->tb__DOT__in1 = VL_RAND_RESET_I(8);
    vlSelf->tb__DOT__in2 = VL_RAND_RESET_I(8);
    vlSelf->tb__DOT__op = VL_RAND_RESET_I(4);
    vlSelf->tb__DOT__rst = VL_RAND_RESET_I(1);
    vlSelf->tb__DOT__clk = VL_RAND_RESET_I(1);
    vlSelf->tb__DOT__out = VL_RAND_RESET_I(8);
    vlSelf->tb__DOT__carryout = VL_RAND_RESET_I(1);
    vlSelf->tb__DOT__overflow = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigprevexpr___TOP__tb__DOT__clk__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigprevexpr___TOP__tb__DOT__rst__0 = VL_RAND_RESET_I(1);
